...
/* 软件 I2C1：SCL→PD10，SDA→PD8，连接 SHT3X-DIS */
#define BSP_USING_I2C1
#ifdef BSP_USING_I2C1
#define BSP_I2C1_SCL_PIN    GET_PIN(D, 10)
...
#define PWM1_CONFIG     {0}

#define BSP_USING_PWM4      //使用PWM4设备，连接到电机驱动的是TIM4外设对应的引脚
#define BSP_USING_PWM4_CH3  //使用TIM4外设的CH3通道，连接到电机驱动
#define BSP_USING_PWM4_CH4  //使用TIM4外设的CH3通道，连接到电机驱动
